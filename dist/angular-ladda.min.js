...
!function(e,t){"use strict";if("function"==typeof define&&define.amd)define(["angular","ladda"],t);else{if("undefined"==typeof module||"object"!=typeof module.exports)return t(e.angular,e.Ladda);module.exports=t(require("angular"),require("ladda"))}}(this,function(e,t){"use strict";var a="angular-ladda";return e.module(a,[]).provider("ladda",function(){var t={style:"zoom-in"};return{setOption:function(a){e.extend(t,a)},$get:function(){return t}}}).directive("ladda",["ladda",function(a){return{restrict:"A",priority:-1,link:function(n,d,r){if(d.addClass("ladda-button"),e.isUndefined(d.attr("data-style"))&&d.attr("data-style",a.style||"zoom-in"),e.isUndefined(d.attr("data-spinner-color"))&&d.attr("data-spinner-color",a.spinnerColor||"#fff"),e.isUndefined(d.attr("data-spinner-size"))&&d.attr("data-spinner-size",a.spinnerSize||10),e.isUndefined(d.attr("data-size"))&&d.attr("data-size",a.size),!d[0].querySelector(".ladda-label")){var i=document.createElement("span");i.className="ladda-label",e.element(i).append(d.contents()),d.append(i)}var s=t.create(d[0]);n.$watch(r.ladda,function(t){return t||e.isNumber(t)?(s.isLoading()||s.start(),void(e.isNumber(t)&&s.setProgress(t))):(s.stop(),void(r.ngDisabled&&d.attr("disabled",n.$eval(r.ngDisabled))))})}}}]),a});